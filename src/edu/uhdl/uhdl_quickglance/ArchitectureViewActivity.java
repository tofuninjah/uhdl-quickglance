...
public class ArchitectureViewActivity extends ListActivity {
	private final String KEY_TITLE = "title";
	private final String KEY_DATE = "date";
	public static final String TAG = SpeccolViewActivity.class.getSimpleName();
    ...
    private class GetBlogPostsTask extends AsyncTask<Object, Void, JSONObject>{
		...
		protected JSONObject doInBackground(Object... params) {
		    ...
		    HttpGet httpget = new HttpGet("http://weblogs.lib.uh.edu/architecture_art/?json=get_recent_posts");
